...
module publicIPAddress '../publicIPAddresses/public-ip-address.bicep' = if (empty(publicIPResourceID) && azureSkuName == 'AZFW_VNet') {
...
module managementIPAddress '../publicIPAddresses/public-ip-address.bicep' = if (isCreateDefaultManagementIP && azureSkuName == 'AZFW_VNet') {
