...
resource profile 'Microsoft.Cdn/profiles@2024-05-01-preview' = {
  name: afdName
  location: 'Global'
  tags: tags
  sku: {
...
resource afdOrigins 'Microsoft.Cdn/profiles/originGroups/origins@2024-05-01-preview' = [
  for (origin, index) in origins: {
    ...
    properties: {
      ...
      sharedPrivateLinkResource: empty(origin.privateLinkOrigin)
        ? null
        : {
            privateLink: {
            ...
            groupId: (origin.privateLinkOrigin.privateLinkResourceType != '')
              ? origin.privateLinkOrigin.privateLinkResourceType
              : null
...
resource originRoute 'Microsoft.Cdn/profiles/afdEndpoints/routes@2024-05-01-preview' = {
  parent: endpoint
...
resource afdWafSecurityPolicy 'Microsoft.Cdn/profiles/securityPolicies@2024-05-01-preview' = {
  parent: profile
